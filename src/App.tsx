...
export default function App() {
  ...
  const handleSignIn = (email: string, password: string): { success: boolean; error?: string } => {
  ...
  const handleSignUp = (email: string, password: string, fullName: string): { success: boolean; error?: string } => {
